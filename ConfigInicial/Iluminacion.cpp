...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //Estas variables al ajustarlas y jugar con ellas se puede ajustar el nivel de realismo 
        ...
        //Parámetro de tipo flotante para el brillo
        ...
        //Esta línea es para cargar la caja
        //glDrawArrays(GL_TRIANGLES, 0, 36);
        
        //Esta línea es para cargar un modelo
